			...
			const installedContent = () => {
				...
				return react_jsx_runtime.jsxs(react_jsx_runtime.Fragment, { children: [
					...
					react_jsx_runtime.jsxs("div", { className: "dsmkGroup", children: [
						...
						react_jsx_runtime.jsxs("div", { className: "dsmkPending" + (togglePending > 0 ? "" : " dsmkPendingHidden"), children: [
							react_jsx_runtime.jsx("span", { children: togglePending > 0 ? fmt(t("market.toggle.pending"), { n: togglePending }) : " " }),
							restartAvailable()
								? react_jsx_runtime.jsx("button", {
									type: "button", className: "dsmkGhostBtn", tabIndex: togglePending > 0 ? 0 : -1,
